...
import com.gorest.userandpostinfo.UsersSteps;
...
public class UsersCRUDTest extends TestBase {
    ...
    static String name = TestUtils.getRandomValue() + "Smart";
    static String email = TestUtils.getRandomValue() + "tester@gmail.com";
